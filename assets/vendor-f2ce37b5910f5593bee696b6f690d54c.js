...
return e.shiftKey&&t.push("shift"),e.altKey&&t.push("alt"),e.ctrlKey&&t.push("ctrl"),e.metaKey&&t.push("meta"),t}(e),e):o=!1)}function g(e,t,r,a){function l(t){return function(){s=t,++i[e],clearTimeout(n),n=setTimeout(u,1e3)}}function p(t){m(r,t,e),"keyup"!==a&&(o=c(t)),setTimeout(u,10)}i[e]=0
for(var h=0;h<t.length;++h){var f=h+1===t.length?p:l(a||d(t[h+1]).action)
v(t[h],f,a,e,h)}}function v(e,t,n,i,o){r._directMap[e+":"+n]=t
var a,s=(e=e.replace(/\s+/g," ")).split(" ")
s.length>1?g(e,s,t,n):(a=d(e,n),r._callbacks[a.key]=r._callbacks[a.key]||[],h(a.key,a.modifiers,{type:a.action},i,e,o),r._callbacks[a.key][i?"unshift":"push"]({callback:t,modifiers:a.modifiers,action:a.action,seq:i,level:o,combo:e}))}r._handleKey=function(e,t,r){var n,i=h(e,t,r),o={},l=0,c=!1
